...
// Fallback local hook in case ../hooks/useAuth is missing
// Keeps this component self-contained and avoids import errors during build.
function useAuth() {
    // Return shape expected by this component: { current: user | null }
